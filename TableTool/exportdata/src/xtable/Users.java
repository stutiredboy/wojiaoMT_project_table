...
public class Users {
	...
	public static String selectPlat(Long key) {
		return getTable().select(key, new xdb.TField<xbean.UserInfo, String>() {
				public String get(xbean.UserInfo v) { return v.getPlat(); }
			});
	}

	public static String selectUid(Long key) {
		return getTable().select(key, new xdb.TField<xbean.UserInfo, String>() {
				public String get(xbean.UserInfo v) { return v.getUid(); }
			});
	}
