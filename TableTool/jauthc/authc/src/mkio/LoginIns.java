...
public class LoginIns implements ILoginIns 
{
	...
	private mkio.Connector _connector;
	private mkio.Mkio _xio;
	...
	public void setXio(mkio.Mkio io)
	{
		_xio = io;
	}
	
	public mkio.Mkio getMkio()
	{
		return _xio;
	}
	...
	/* (non-Javadoc)
	 * @see src.ILoginIns#send(mkio.Protocol)
	 */
	@Override
	...
	public void start() 
	{
		...
		try 
		{
			_connector = mkio.Connector.create(_manager, self);
			_connector.open();
	...
	public mkio.Connector getConnector() 
	{
		return _connector;
	}
