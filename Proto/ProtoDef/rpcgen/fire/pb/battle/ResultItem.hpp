...
#include "fire/pb/battle/SubResultItem.hpp"
#include <list>
#include <map>
...
class ResultItem : public FireNet::Marshal
{
public:
	fire::pb::battle::DemoExecute execute;
	std::list<fire::pb::battle::SubResultItem> subresultlist;
	...
	ResultItem(const fire::pb::battle::DemoExecute & _execute_, const std::list<fire::pb::battle::SubResultItem> & _subresultlist_, const std::list<fire::pb::battle::FighterInfo> & _newfighter_, const std::map<int, float> & _rolechangedattrs_, const std::map<int, float> & _petchangedattrs_)
	...
	bool _validator_() const {
		...
		for (std::list<fire::pb::battle::SubResultItem>::const_iterator _i_ = subresultlist.begin(); _i_ != subresultlist.end(); ++_i_)
