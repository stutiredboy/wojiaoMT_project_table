...
<#if !defineOnly>			
	...
	public static Integer getIntegerCellValue(Row w,String name,java.util.ArrayList<String> collnames){
		...
		/*
		if (name.equals("摆摊冻结时间")) {
			Boolean bis = (c.toString() == "");
			logger.error("文件名是:"+c.toString()+"end" + bis.toString());
		}*/
		if (c.toString() == "")
			return null;
		...
		case Cell.CELL_TYPE_STRING:
			{
				...
				if(t.equals("是") || t.equals("true") || t.equals("TRUE"))
					return true;
				else if(t.equals("否") || t.equals("false") || t.equals("FALSE"))
					return false;
				else
