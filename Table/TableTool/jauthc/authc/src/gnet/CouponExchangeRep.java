...
abstract class __CouponExchangeRep__ extends mkio.Protocol { }

// DO NOT EDIT THIS }}}
// RPCGEN_IMPORT_END }}}

public class CouponExchangeRep extends __CouponExchangeRep__ {
	@Override
	...
	// {{{ RPCGEN_DEFINE_BEGIN
	// {{{ DO NOT EDIT THIS
	public static final int PROTOCOL_TYPE = 219;
	...
	public CouponExchangeRep() {
	}

	public CouponExchangeRep(int _retcode_, int _userid_, int _remain_coupon_, int _today_exchange_coupon_, int _today_remain_exchange_coupon_, int _reserved1_, int _reserved2_) {
	...
	public boolean equals(Object _o1_) {
		...
		if (_o1_ instanceof CouponExchangeRep) {
			CouponExchangeRep _o_ = (CouponExchangeRep)_o1_;
	...
	public int compareTo(CouponExchangeRep _o_) {
